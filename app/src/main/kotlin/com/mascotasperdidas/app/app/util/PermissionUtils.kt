...
object PermissionUtils {
    ...
    fun getRequiredPermissions(): List<PermissionDef> = buildList {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU) {
            ...
            add(PermissionDef(com.mascotasperdidas.app.R.string.permissions_storage, Manifest.permission.READ_EXTERNAL_STORAGE))
        }
        add(PermissionDef(com.mascotasperdidas.app.R.string.permissions_location, Manifest.permission.ACCESS_FINE_LOCATION))
    }
